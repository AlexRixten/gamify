    ...
    <View>
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>
          Levels ({fitnessPreset.levels.length})
        </Text>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>
          Badges ({fitnessPreset.badges?.length || 0})
        </Text>
...
export const Achievements: StoryObj = {
  render: () => {
    const categories = [
      ...new Set(fitnessPreset.achievements?.map((a) => a.category)),
    ];
    return (
      <View>
        {categories.map((category) => (
          <View key={category} style={styles.section}>
            <Text style={styles.sectionTitle}>
              ...
              {
                fitnessPreset.achievements?.filter(
...
export const Badges: StoryObj = {
  render: () => {
    const badgesByRarity = {
      ...
      legendary:
        fitnessPreset.badges?.filter((b) => b.rarity === 'legendary') || [],
    };
